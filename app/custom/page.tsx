...
const Custom = () => {
	...
	return (
		<main className="py-3 flex flex-col gap-3 w-full items-center h-full md:py-28">
			<Link
				href="/custom/June_10_2023_9_00pm"
				className="border transition duration-300 ease-in-out border-[#FFD600] w-[85%] max-w-2xl py-5 sm:py-10 rounded-xl cursor-pointer overflow-hidden group">
