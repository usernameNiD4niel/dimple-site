...
const MyHeroes = () => {
	...
	return (
		<main className="py-3 flex flex-col gap-3 w-full items-center md:py-24">
			<section>
				<ul className="flex flex-col items-center gap-3 mb-10 md:grid md:grid-cols-3 md:items-start">
